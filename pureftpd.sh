...
clear
echo "+----------------------------------------------------------+"
echo "|          Pureftpd for nextLNMP,  by nextLNMP team      |"
echo "+----------------------------------------------------------+"
echo "|This script is a tool to install pureftpd for nextLNMP        |"
echo "+----------------------------------------------------------+"
...
Install_Pureftpd()
{
    ...
    if [[ -s /usr/local/pureftpd/sbin/pure-ftpd && -s /usr/local/pureftpd/etc/pure-ftpd.conf && -s /etc/init.d/pureftpd ]]; then
        ...
        Echo_Green "| =>use command: nextlnmp ftp {add|list|del|show} to manage FTP users."
        Echo_Green "+----------------------------------------------------------------------+"
        Echo_Green "| For more information please visit https://nextlnmp.com"
        Echo_Green "+----------------------------------------------------------------------+"
    else
