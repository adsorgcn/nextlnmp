...
Display_Upgrade_Menu()
{
    ...
    echo "4: Upgrade PHP for nextLNMP"
    echo "5: Upgrade PHP for nextLNMPA or NextLAMP"
...
clear
echo "+-----------------------------------------------------------------------+"
echo "|            Upgrade script for nextLNMP V2.1, by nextLNMP team       |"
echo "+-----------------------------------------------------------------------+"
echo "|     A tool to upgrade Nginx,MySQL/Mariadb,PHP for nextLNMP/nextLNMPA/NextLAMP     |"
echo "+-----------------------------------------------------------------------+"
